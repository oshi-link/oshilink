...
function renderCalendar(){
 ...
 if(!items.length)$('event-list').append(empty($('demo').checked?'条件に合うライブはありません':'まだライブが掲載されていません。','別の日付や地域を選んでお試しください。'));
...
try{
 ...
 $('data-status').textContent='公開中の情報を表示しています';
